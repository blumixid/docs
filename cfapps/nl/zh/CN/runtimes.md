...
使用运行时可快速启动应用程序并运行，无需设置和管理 VM 与操作系统。{{site.data.keyword.Bluemix_notm}} 中的运行时基于 Cloud Foundry，这意味着 Cloud Foundry 的社区 buildpack 或工具插件也可与 {{site.data.keyword.Bluemix_notm}} 一起使用。
首先，检查不断增长的运行时列表。
{:shortdesc}
...
<p class="runtimeLink"><a format="html" href="../runtimes/liberty/index.html" scope="peer">查看文档</a></p>
</li>
<li>
...
<li>
<p class="runtimeIcon"><img src="images/dotnet_featured.svg" alt="ASP.NET 核心" /></p>
<p class="runtimeTitle">ASP.NET 核心</p>
<p class="runtimeLink"><a format="html" href="../runtimes/dotnet/index.html" scope="peer">查看文档</a></p>
</li>
<li>
