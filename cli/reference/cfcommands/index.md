...
Log in to {{site.data.keyword.Bluemix_notm}} with a defined endpoint of `https://api.chinabluemix.net`.
```
cf login -a https://api.chinabluemix.net
```
{: codeblock}

Log in to {{site.data.keyword.Bluemix_notm}} with a defined endpoint of `https://api.chinabluemix.net`, a user name of `user_name`, and no specified password for security reasons.
```
cf login -a https://api.chinabluemix.net -u user_name
```
{: codeblock}

Log in to {{site.data.keyword.Bluemix_notm}} with a defined endpoint of `https://api.chinabluemix.net`, a user name of `user_name`, no specified password for security reasons, and an organization name of `org_name` and space name of `space_name`.
```
